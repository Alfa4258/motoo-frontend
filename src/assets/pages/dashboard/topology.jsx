                ...
                <section className='flex gap-4'>
                            ...
                            {load ? (
                                ...
                                <>
                                    ...
                                    <table className="w-full table-x table">
                                        <thead>
                                            <tr>
                                                {["group", "link", "description", "status"].map((el) => (
                                        ...
                                        <tbody>
                                            {currentData.map((item, index) => (
                                                <tr key={index} onClick={() => handleOpen(item.id)} className="hover:bg-gray-300 border-b border-gray-400 text-wrap">
                                                    <td>{item.group}</td>
                                                    <td>{item.link}</td>
                    ...
                    <div className={open ? "hidden md:block lg:w-3/12 shadow-xl px-2 py-4 min-h-screen bg-gray-200" : "hidden"}>
                        ...
                        <div role="tablist" className="tabs tabs-boxed mt-4 bg-gray-200">
                            ...
                            <div role="tabpanel" className="tab-content bg-base-100"></div>
                        </div>
                    </div>
