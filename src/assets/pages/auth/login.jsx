                        ...
                        <form className="card-body" onSubmit={handleSubmit}>
                            ...
                            <div className="py-4">
                                <div className="form-control mb-2 border-2 border-gray-300 rounded-lg overflow-hidden focus-within:border-red-500">
                                    <div className="join">
                                        <button className="btn join-item btn-primary"tabIndex={-1} ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                ...
                                <div className="form-control">
                                    <div className="join border-2 border-gray-300 rounded-lg overflow-hidden focus-within:border-red-500">
                                        <button className="btn btn-primary join-item" tabIndex={-1}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <span className="text-sm italic font-semibold">Belum memiliki akun? <a className = "text-primary "href="/register">Daftar</a> </span>
                        </form>
                    </div>
                </div>
            </div>
