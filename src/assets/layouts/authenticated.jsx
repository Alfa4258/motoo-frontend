...
function AuthLayout() {
    ...
    const [layout, page, subpage, item] = pathname.split("/").filter((el) => el !== "");
                                    ...
                                    <li className=''>
                                        <details>
                                            <summary className='uppercase text-base-100 font-bold' >
                                                ...
                                                <li><Link to={"/dashboard/virtual_machines"} className='uppercase'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <ul>
                                <li>
                                    <Link to={`/${layout}`}>
                                        ...
                                        <span className='mx-1 capitalize'>{layout}</span>
                                    </Link>
                                </li>
                                {page &&
                                    <li>
                                        <Link to={`/${layout}/${page}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="w-6 h-6 stroke-current"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path></svg>
                                            <span className='mx-1 capitalize'>{page}</span>
                                        </Link>
                                    </li>
                                }
                                {subpage && (<li>
                                    <span className="inline-flex gap-2 items-center">
                                        <span className='mx-1 capitalize'>{subpage}</span>
                                    </span>
                                </li>)}
                                {item && (<li>
                                    <span className="inline-flex gap-2 items-center">
                                        <span className='mx-1 capitalize'>{item}</span>
                                    </span>
                                </li>)}
                            </ul>
                        </div>
